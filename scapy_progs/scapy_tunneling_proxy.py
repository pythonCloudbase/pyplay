# ICMP tunneling
# from https://github.com/YonatanErez/Scapy-ICMP-Tunneling-Proxy/blob/master/tunnel.py
...
#Common linux windows, scapy icmp payloads for ping
...
def filter_function(packet):
    ...
    print_in_thread('[*] Inside filter function')
    # print(packet.show())
    print('does it have TCP: ', packet.haslayer('IP'))
    print('does it have: ', packet.haslayer('ICMP'))
...
def main():
    ...
    print(str(output))
    MY_LOCAL_IP = str(output).split(' ')[0]
